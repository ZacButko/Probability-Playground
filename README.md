...
Investigation into how different game mechancis from the classic board game 'Monopoly' affect probability of landing on various spaces
...
The role playing game 'Star Wars' has special dice; instead of having sides with numbers 1-N, they instead have two different mechanics "Success" and "Advantage" with varying prevalance on each side shown.

In progressing one's character in the game the player has a choice, substitute one of three d8 dice for a d12, or add one d6 to your pool of three d8. We maximizing for both mechanics and plot the results on an at-least graph, showing the advantage of picking up an extra dice instead of subsituting
